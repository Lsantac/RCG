      ...
      if (file_exists('http://redecolaborativa.ddns.net:8221/RedeColaborativa/public/icons')){
          if($row_markers['status']==2){
            ...
            if($row_markers['status']==3){
              echo 'colo r= "http://redecolaborativa.ddns.net:8221/RedeColaborativa/public/icons/marcador_parcial.png" ';
            }else{
              if($row_markers['status']==4){
                ...
                echo 'color = "http://redecolaborativa.ddns.net:8221/RedeColaborativa/public/icons/marcador_laranja.png" ';
              }
            }  
